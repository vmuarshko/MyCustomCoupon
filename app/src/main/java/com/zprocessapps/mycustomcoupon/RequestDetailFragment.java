...
import com.zprocessapps.mycustomcoupon.objects.dummy.DummyContent;
 ...
 * in two-pane mode (on tablets) or a { RequestDetailActivity}
 * on handsets.
 */
public class RequestDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            //((TextView) rootView.findViewById(R.id.request_detail)).setText(mItem.details);
        }
